                ...
                <tr key={reg.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2 justify-end">
                      ...
                      <button
                        onClick={async () => await updateStatus(reg.id, 'reviewing')}
                      ...
                      <button
                        onClick={async () => await updateStatus(reg.id, 'approved')}
                      ...
                      <button
                        onClick={async () => await updateStatus(reg.id, 'rejected')}
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={async () => {
                        await updateStatus(selectedRegistration.id, 'reviewing');
                    ...
                    <button
                      onClick={async () => {
                        await updateStatus(selectedRegistration.id, 'approved');
                        setSelectedRegistration(null);
                      }}
                    ...
                    <button
                      onClick={async () => {
                        await updateStatus(selectedRegistration.id, 'rejected');
                        setSelectedRegistration(null);
                      }}
